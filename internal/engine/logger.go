...
// All methods are nil-safe. When quiet is true, all output is suppressed.
type Logger struct {
	w       io.Writer
	verbose bool
	quiet   bool
...
func NewLogger(verbose bool, quiet bool) *Logger {
	return &Logger{w: os.Stderr, verbose: verbose, quiet: quiet}
}
